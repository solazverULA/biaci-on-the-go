...
class Notregisteduser(unittest.TestCase):
    def setUp(self):
    ...
    def test_notregisteduser(self):
        driver = self.driver
        driver.get("http://127.0.0.1:8000/users/login/")
        driver.find_element_by_link_text("Sign Up").click()
        time.sleep(0.5)
        driver.find_element_by_id("id_username").clear()
        driver.find_element_by_id("id_username").send_keys("Gustavo2718")
        time.sleep(0.5)
        driver.find_element_by_id("id_first_name").clear()
        driver.find_element_by_id("id_first_name").send_keys("Gustavo")
        time.sleep(0.5)
        ...
        driver.find_element_by_id("id_cedula").send_keys("V025793732")
        time.sleep(0.5)
        driver.find_element_by_id("id_email").clear()
        driver.find_element_by_id("id_email").send_keys("gustavo@gmail.com")
        time.sleep(0.5)
        driver.find_element_by_id("id_cod_area").clear()
        driver.find_element_by_id("id_cod_area").send_keys("0274")
        time.sleep(0.5)
        driver.find_element_by_id("id_num_telefono").clear()
        driver.find_element_by_id("id_num_telefono").send_keys("2218496")
        time.sleep(0.5)
        ...
        driver.find_element_by_id("id_direccion").click()
